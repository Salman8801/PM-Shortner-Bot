...
PICS = (environ.get('PICS', 'https://telegra.ph/file/12f6e94992c048e58a0ff.jpg')).split()
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/12f6e94992c048e58a0ff.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://telegra.ph/file/12f6e94992c048e58a0ff.jpg")
SPELL_IMG = environ.get("https://telegra.ph/file/d4a059c7f0ffde8a45336.jpg")
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5403432874').split()]
auth_channel = environ.get('AUTH_CHANNEL')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001814749004')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001814749004')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001942978126'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'allmovises0')
